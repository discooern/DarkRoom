...
import { stokeFire } from './src/main.js'
...
class Stage {
    constructor(canvas, pixelate = false, background = false) {
        ...
        flames.map((settings) => {
            ...
            fire.scale = settings.scale * fireSize.value;
        ...
        document.querySelector(".stokeBtn").addEventListener('click', e => {
            ember.stoke();
            stokeFire();
...
//     }
//     loop.value += 1;
//     console.log("no new scale found");
